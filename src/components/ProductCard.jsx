...
const ProductCard = ({ product, onClick }) => {
  return (
    <div
      ...
      className="bg-darkGray p-3 rounded-lg shadow-card cursor-pointer transition-shadow duration-300 flex flex-col items-center w-[250px] h-[260px]" // Styling classes for appearance and interactivity
    >
      <img
      ...
      />
      <h2 className="text-lg font-playfair text-center text-foreground">{product.title}</h2> {/* Display product title */}
